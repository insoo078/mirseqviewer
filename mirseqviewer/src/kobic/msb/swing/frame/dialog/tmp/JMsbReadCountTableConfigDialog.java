//package kobic.msb.swing.frame.dialog.tmp;
//
...
//
//		this.currentRCTColumnStructureModel = remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel();
//
...
//				if( e.getModifiers() == InputEvent.BUTTON1_MASK && e.getClickCount() == 2 && !e.isConsumed() ) {
...
//						column = remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().getChoosedGroupMap().get( parentItem );
...
//					if( remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().getSampleSize() < 1 ) {
//						if( remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().getChoosedGroupMap().containsKey( JMsbSysConst.TOTAL_SUM_HEADER ) )
...
//			    		if( column2 == null ) {
//			    			column2 = remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().getColumnModel( key2 );
//			    		}
//
...
//		    		if( column == null ) {
//		    			column = remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().getColumnModel( key );
//		    		}
...
//	    }
//
//	    remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().setChoosedGroupMap( tmpMap );
//	}
//	
...
//	    }
//
//	    remote.dockWindow.getModel().getMSBReadCountTableColumnStructureModel().setUnusedGroupMap( tmpMap );
//	}
//
...
//
//		this.treeColumnStructure.setModel( JMsbReadCountTableConfigDialog.createColumnStructureTreeModel(this.dockWindow.getModel().getMSBReadCountTableColumnStructureModel()) );
//		this.treeUnusedSamples.setModel( JMsbReadCountTableConfigDialog.createUnusedSampleTreeModel(this.dockWindow.getModel().getMSBReadCountTableColumnStructureModel()) );
//
