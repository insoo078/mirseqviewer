...
public class JFontChooser extends JComponent
{
	...
	public JFontChooser(String fontName, String style, String size)
	{
		this(DEFAULT_FONT_SIZE_STRINGS);

		this.fontFamilyTextField.setText( fontName );
		this.fontStyleTextField.setText( style );
		this.fontSizeTextField.setText( size );
	}
