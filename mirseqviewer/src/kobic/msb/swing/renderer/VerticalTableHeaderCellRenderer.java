...
import kobic.msb.swing.plaf.VerticalLabelUI;

/**
 * A renderer for a JTableHeader with text rotated 90째 counterclockwise.
 * <P>
...
/**
  ...
  /**
   * An icon implementation to paint the contained icon rotated 90째 clockwise.
   * <P>
  ...
  private enum VerticalSortIcon implements Icon {
     ...
     * rotated by 90째 clockwise.  This rotation is applied to compensate
